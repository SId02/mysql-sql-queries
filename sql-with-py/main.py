...
create_database_query = "Create database mysql_py"
...
(103,'Stacy','Trousers','2019-12-25',5,50,'897612645'),
(104,'Nancy','T-Shrits','2018-07-14',7,30,'7368145099'),
...
q3 = """
select year(date_orders) from   orders;           
"""
connection = create_db_connection("localhost", "root", pw, db)
...
q4 = """
select distinct year(date_orders) from   orders;           
"""
connection = create_db_connection("localhost", "root", pw, db)
