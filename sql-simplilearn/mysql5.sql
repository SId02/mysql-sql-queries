...
values	(new.id,concat('Hi',new.name,'please	update	your	datef=ofbirth'));
end	if	;
end	 //
delimiter ;

insert	into	customers1(name,email,birthdate)
values("Nancy",'nancy@email.com',NULL),
("Ronald","ronald@xyz.com","1998-11-16"),
("Chris","chris@xyz.com","1997-08-28"),
("Alice","alice@asd.com",NULL);
